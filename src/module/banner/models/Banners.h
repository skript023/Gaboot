...
class Banners
{
  public:
     ...
     */
    explicit Banners(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Banners(const Json::Value &pJson) noexcept(false);
     ...
     */
    Banners(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Banners>;
    friend drogon::orm::BaseBuilder<Banners, true, true>;
    friend drogon::orm::BaseBuilder<Banners, true, false>;
    friend drogon::orm::BaseBuilder<Banners, false, true>;
    friend drogon::orm::BaseBuilder<Banners, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Banners>;
#endif
