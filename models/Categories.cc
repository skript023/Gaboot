...
MasterProducts Categories::getMaster_products(const DbClientPtr &clientPtr) const {
    static const std::string sql = "select * from master_products where category_id = $1";
    Result r(nullptr);
    {
